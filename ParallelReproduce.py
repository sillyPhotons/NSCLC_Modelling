...
for stage in [1]:
    ...
    #     sampling_range[0], sampling_range[1]*31 + c.RESOLUTION, c.RESOLUTION), pop_manager, m.discrete_time_tumor_volume_GENG)
    ...
    res_manager.record_prediction(
        ResultObj(plt.step, x, data, "Months",
                  "Proportion of Patients Alive", curve_label="Radiotherapy Data", label="Radiotherapy Data", color="black", alpha=0.7),
